...
@testset "UnitfulGaussian.jl" begin
    ...
    @testset "Test conversions" begin
        ...
        @test uconvert(T, 1G, MagneticFieldEquivalence()) ≈ 1.0e-4T
        @test uconvert(G, 1T, MagneticFieldEquivalence()) == 1.0e4G
        ...
        @test uconvert(Mx, 1Wb, MagneticFluxEquivalence()) == 1.0e8Mx
        @test uconvert(Wb, 1Mx, MagneticFluxEquivalence()) ≈ 1.0e-8Wb
